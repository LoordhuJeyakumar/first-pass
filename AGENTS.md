...
5. **Deterministic Check Engine.** The LLM orchestrates and explains findings, but **never computes measurements**. Audio loudness, True Peak, HDR metadata, subtitle coverage, and packaging checks must be computed by pure, deterministic Python code.
...
docs/        Public documentation (ARCHITECTURE.md, DOMAIN.md, DISCLOSURE.md, evidence.md)
```
